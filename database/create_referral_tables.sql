...
CREATE TABLE IF NOT EXISTS direct_referral_rewards (
    ...
    maturity_time TIMESTAMP NOT NULL COMMENT '到期时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='直推奖励记录表';
...
CREATE TABLE IF NOT EXISTS referral_settlement_batches (
    ...
    INDEX idx_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='每周结算批次表';
