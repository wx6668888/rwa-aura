  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <Link
          href="/node/network"
          className="flex w-full items-center justify-center rounded-full border border-[#00f5d460] bg-[#00f5d418] px-6 py-3 text-[13px] font-semibold text-[#00f5d4] transition-all hover:bg-[#00f5d428] hover:shadow-[0_0_20px_rgba(0,245,212,0.25)]"
        >
          {t('networkDoc.pageTitle')}
        </Link>
        <button
          type="button"
          onClick={() => setShowTreeModal(true)}
          className="w-full rounded-full border border-[#00f5d430] bg-transparent px-6 py-3 text-[13px] text-[#00f5d4] transition-all hover:border-[#00f5d460] hover:bg-[#00f5d410] hover:shadow-[0_0_20px_rgba(0,245,212,0.3)]"
        >
