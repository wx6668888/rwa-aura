...
/**
 * 结构、横滚参数参考 Pendle：https://www.pendle.finance/
 * wave.mp4 与 brands/*.webp 已放入 public/；仅标题颜色为本站品牌发光青。
 */
...
/** 与 Pendle 同款品牌图（自托管于 public/images/brands） */
...
function BrandStrip({ animate }: { animate: boolean }) {
  return (
    <div
      className={cn(
        'flex shrink-0 items-center gap-20 pr-20',
        animate && 'animate-marquee-x-pendle',
      )}
    >
