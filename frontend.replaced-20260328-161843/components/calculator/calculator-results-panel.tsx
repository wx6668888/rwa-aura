      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[13px] text-text-secondary">{t('calc.projectDividend')}</span>
            {!results.projectDividendEligible && (
              <span className="text-[10px] px-2 py-0.5 rounded-full border border-white/10 bg-white/[0.03] text-white/60">
                {t('calc.projectDividendNeedL4')}
              </span>
            )}
          </div>
          <span className="font-jetbrains text-purple-400 text-[14px] font-bold">
            +${results.projectDividend.toFixed(2)}
          </span>
        </div>
