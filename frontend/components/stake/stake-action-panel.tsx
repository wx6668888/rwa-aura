...
export function StakeActionPanel() {
  ...
  // 当 userStakeInfo 加载完成后，如果已有推荐人，清空本地输入的推荐人地址
  useEffect(() => {
