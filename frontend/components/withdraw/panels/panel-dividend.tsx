      ...
      <div className="flex items-center justify-between p-5 border-b border-[rgba(0,255,200,0.1)]">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00ffc8] to-[#00d4aa] flex items-center justify-center">
            <Gift className="w-5 h-5 text-[#0a0a0f]" />
          </div>
          <div>
            <h2 className="text-[16px] font-[700] text-[#f1f5f9]">项目分红</h2>
            <p className="text-[12px] text-[rgba(238,242,255,0.52)] mt-0.5">持有 stRWA，享受分红</p>
          </div>
        </div>
        ...
        {hasDividend ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-20 h-20 rounded-full bg-[rgba(255,255,255,0.03)] flex items-center justify-center mb-4">
              <Gift className="w-10 h-10 text-[rgba(238,242,255,0.26)]" />
            </div>
            <div className="text-[rgba(238,242,255,0.52)] text-[14px]">暂无项目分红</div>
          </div>
        )}
      </div>
