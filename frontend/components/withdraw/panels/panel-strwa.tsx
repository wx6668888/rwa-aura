    ...
    <div className="flex flex-col h-full bg-gradient-to-br from-[#0a0a0f] via-[#0d0d14] to-[#0a0a0f]">
      ...
      <div className="flex items-center justify-between p-5 border-b border-[rgba(0,255,200,0.1)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[16px] font-[700] text-[#f1f5f9]">stRWA 代币</h2>
            <p className="text-[12px] text-[rgba(238,242,255,0.52)] mt-0.5">质押凭证，可交易</p>
          </div>
        </div>
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        {hasStrwa ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <div className="text-[rgba(238,242,255,0.52)] text-[14px]">暂无 stRWA 代币</div>
          </div>
        )}
      </div>
