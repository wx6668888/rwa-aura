            ...
            <div className="py-20 text-center">
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/20 to-teal-500/20">
                {(() => {
                  ...
                  return <Icon className="h-8 w-8 text-emerald-400" />
                })()}
              </div>
              <h2 className="mb-2 text-2xl font-bold text-white">{items.find((i) => i.id === activePanel)?.name}</h2>
              <p className="mb-6 text-white/40">{items.find((i) => i.id === activePanel)?.desc}</p>
              ...
              <button
                type="button"
                className="rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-3 font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all hover:from-emerald-600 hover:to-teal-700"
              >
                Withdraw Now
              </button>
            </div>
